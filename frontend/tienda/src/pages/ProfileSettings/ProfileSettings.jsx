...
export default function ProfileSettings() {
  const [form, setForm] = useState({ firstName: 'Julianne', lastName: 'Moore', email: 'julianne@alpacart.com', phone: '+1 (555) 000-0000', language: 'es', currency: 'USD', comms: true });
      ...
      <div className={styles.main}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.grid}>
            ...
            <div className={styles.field}><label className={styles.label}>Correo electrónico</label><input className={styles.input} name="email" value={form.email} onChange={handleChange} /></div>
        ...
        <section className={styles.section}>
          ...
          <label className={styles.checkbox}><input type="checkbox" checked={form.comms} onChange={() => setForm({ ...form, comms: !form.comms })} /> <span>Recibir comunicaciones comerciales</span></label>
        </section>
