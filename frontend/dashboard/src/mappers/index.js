import { createUser, createRole, createPermission, createProduct, createOrder, createClient, createCampaign, createContent, createStockItem, createTransaction, createShipment, createAuditLog, createCompanySetting, createAnalyticsKpi } from '@/domain';
...
export const mapProducts = (r) => { const list = r?.data || r?.rows || r || []; return Array.isArray(list) ? list.map(createProduct) : []; };
...
export const mapKpis = (r) => createAnalyticsKpi(r?.data || r);
