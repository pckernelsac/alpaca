...
/* --------------------------------------------------------------------------
   Propios del sitio institucional: los pasos del taller y la ficha de contacto.
   Los nombres que llegan del CMS son de Material Symbols; el mapa que los
   traduce a estos dibujos vive en components/site/iconos.ts.
   -------------------------------------------------------------------------- */

export function IconScissors({ size = 24, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
...
export function IconFunnel({ size = 24, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
...
export function IconDrop({ size = 24, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
      <path d="M12 3.5c3.2 3.6 5 6.3 5 8.8a5 5 0 0 1-10 0c0-2.5 1.8-5.2 5-8.8Z" />
    </svg>
  );
}

export function IconThread({ size = 24, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
...
export function IconPalette({ size = 24, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
      <path d="M12 3a9 9 0 0 0 0 18c1.4 0 2-1 1.4-2-.7-1.2.2-2.3 1.6-2.3H17a4 4 0 0 0 4-4c0-5.1-4-9.7-9-9.7Z" />
...
export function IconVerified({ size = 24, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
      <path d="m12 3 2.3 1.8 2.9-.2.5 2.9L20 9.6 18.7 12 20 14.4l-2.3 2.1-.5 2.9-2.9-.2L12 21l-2.3-1.8-2.9.2-.5-2.9L4 14.4 5.3 12 4 9.6l2.3-2.1.5-2.9 2.9.2L12 3Z" />
...
export function IconPhone({ size = 20, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
      <path d="M7 3.5 9.5 8 7.8 10a11 11 0 0 0 6.2 6.2l2-1.7 4.5 2.5v3a1.5 1.5 0 0 1-1.7 1.5C10.4 20.5 3.5 13.6 2.7 5.2A1.5 1.5 0 0 1 4.2 3.5h2.8Z" />
    </svg>
  );
}

export function IconPin({ size = 20, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
...
export function IconClock({ size = 20, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
      <circle cx="12" cy="12" r="9" />
...
export function IconChat({ size = 20, strokeWidth = 1.5, className }: IconProps) {
  return (
    <svg {...base(size, strokeWidth, className)}>
...
/** Comilla de apertura, sólida: es ornamento, no un trazo más. */
export function IconQuote({ size = 48, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      focusable="false"
    >
      <path d="M9.6 5.4c-3 1.6-4.8 4.3-4.8 7.6v5.6h6.4v-6.4H8.4c0-1.9.9-3.4 2.7-4.4l-1.5-2.4Zm9.2 0c-3 1.6-4.8 4.3-4.8 7.6v5.6h6.4v-6.4h-2.8c0-1.9.9-3.4 2.7-4.4l-1.5-2.4Z" />
    </svg>
  );
}
